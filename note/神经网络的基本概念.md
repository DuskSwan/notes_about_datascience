...
>\end{pmatrix}^T
>$$
>注意，在上式中，导数的符号是严格按照数学中雅可比矩阵的定义写的，因而”梯度向量“是一个行向量，而不是机器学习中常用的列向量。
>
...
= \left(\begin{matrix} 
		\frac{\part h_1}{\part i_1} & \frac{\part h_1}{\part i_2} \\ 
		\frac{\part h_2}{\part i_1} & \frac{\part h_2}{\part i_2}
  \end{matrix}\right)
= W_1 \\
$$
可知损失函数关于输入
